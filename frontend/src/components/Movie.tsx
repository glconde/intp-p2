    ...
    <div className="modal">
      ...
      <div className="modal-content">
        <div className="modal-header">
          <CircleX onClick={() => openModal(!modal)} size={30} />
        </div>
        <div className="modal-content-section">
          ...
          <p>
            {data.releaseYear} • {data.genre} • {moviedata && moviedata.Runtime}
          </p>
          {!moviedata ? (
            ...
            <>
              <div className="modal-content-section2">
                <div className="mcs">
                  ...
                  <div>
                    {moviedata && !moviedata.Ratings ? (
                      <p>No ratings available</p>
                    ) : (
                      moviedata &&
                      moviedata.Ratings.map((rating: IRating, i) => {
                        return (
                          <div className="rating" key={i}>
                            <div>{rating.Source}</div> {rating.Value}
                          </div>
                        );
                      })
                    )}
